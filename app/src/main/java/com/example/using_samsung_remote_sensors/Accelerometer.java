...
//
//public class Accelerometer extends MainActivity implements SensorCallBack {
//
//	private RemoteSensorNode nodeToMonitor;
//	public float[] values;
//
//	public Accelerometer(RemoteSensorNode node)
//	{
//		nodeToMonitor=node;
//	}
//	@Override
//	public void onRemoteSensorDataAvailable(RemoteSensorEvent event) {
//		if(event.getNode().getName().equals(nodeToMonitor.getName()) && event.getSensorType()==Sensor.TYPE_ACCELEROMETER)
//		{
